...
% SIC and CCF anlaysis for separable stimulus data from LND2011 (Exp1)
clear all
clc
close all
...
for si = 1:numel(datafiles); % which subject to analyse?
    ...
    axis([250 2500 0 1]) % Sets axis size
    ...
    set(gca,'FontSize', 12, 'XLim', [250 2500], 'YLim', [-.55 .55])
    ...
    set(gca,'FontSize', 12, 'XLim', [mint maxt], 'YLim', [-5 1])
end
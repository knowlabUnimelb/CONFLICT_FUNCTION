...
[mint, maxt, nbootstrap, dt] = optargs{:}; % Place optional args in memorable variable names

%% Compute cdf
t = mint:dt:maxt; % #### set t, time vector in msec (MIN : bin size : MAX)
